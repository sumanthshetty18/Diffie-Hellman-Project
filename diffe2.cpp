...
void red() {
    ...
    outputWhite(90, 170, "2] They select thier private key (red and blue) respectively which is not visible to others.");
...
void orange()
{
    ...
    delay(5000);
    outputWhite(90, 120, "3] They disguise thier private key by mixing it with public key to obtain orange and green.");
...
void brownB()
{
    ...
    outputWhite(90, 70, "4] They mix thier private key and shared secret key to obtain a common color (brown),");
